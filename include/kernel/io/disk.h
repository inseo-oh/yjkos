...
struct pdisk;
struct pdisk_ops {
    FAILABLE_FUNCTION (*write)(struct pdisk *self, void const *buf, diskblkptr_t blockaddr, size_t blockcount);
    FAILABLE_FUNCTION (*read)(struct pdisk *self, void *buf, diskblkptr_t blockaddr, size_t blockcount);
};
