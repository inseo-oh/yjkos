...
NODISCARD struct vmobject *vmm_alloc_object(struct addressspace *self, PHYSPTR physicalbase, size_t size, uint8_t mapflags);
NODISCARD struct vmobject *vmm_alloc_object_at(struct addressspace *self, void *virtualbase, PHYSPTR physicalbase, size_t size, uint8_t mapflags);
