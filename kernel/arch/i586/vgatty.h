...
/*
 * archi586_vgatty_init_earlydebug should only be enabled when debugging very
 * early boot process, and you *have* to boot into text mode as it uses
 * hardcoded textmode parameters.
 */
